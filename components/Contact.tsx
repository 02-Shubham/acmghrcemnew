          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            >
              ...
              <form onSubmit={handleSubmit}>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-full bg-gradient-to-r from-blue-500 to-pink-600 text-white py-3 rounded-lg hover:opacity-90 transition-all"
                >
                  Send Message
                </motion.button>
              </form>
            ...
            >
              ...
              <div className="mt-8 flex space-x-4">
                <motion.a
                  href="https://www.linkedin.com/company/ACM-ghrcem"
                  target="_blank"
                ...
                <motion.a
                  href="https://github.com/ACM-GHRCEM"
                  target="_blank"
                  rel="noopener noreferrer"
                  whileHover={{ scale: 1.2 }}
                  whileTap={{ scale: 0.9 }}
